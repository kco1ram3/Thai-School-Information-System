...
namespace TSIS.Models
{
    public class ModelsRepository
    {
        ...
        public static List<ComboBoxItems> GetComboBoxItems(IList<iSISModel.Semester> Items)
        {
            List<ComboBoxItems> ComboboxItems = new List<ComboBoxItems>();
            foreach (iSISModel.Semester item in Items)
            {
                ComboboxItems.Add(new ComboBoxItems(item.SemesterNo.ToString() + "/" + item.AcademicYear.ToString(), item.ID.ToString()));
            }
            return ComboboxItems;
        }

        public static List<ComboBoxItems> GetComboBoxItems(IList<iSISModel.CurriculumFramework> Items)
        {
            string languageCode = (string)CookieManager.GetCookie(HttpContext.Current, CookieManager.CookieName.CurrentLanguage);
            List<ComboBoxItems> ComboboxItems = new List<ComboBoxItems>();
            foreach (iSISModel.CurriculumFramework item in Items)
            {
                ComboboxItems.Add(new ComboBoxItems(item.Title.GetValue(languageCode), item.ID.ToString()));
            }
            return ComboboxItems;
        ...
        public static List<ComboBoxItems> GetComboBoxItems(IList<iSISModel.Curriculum> Items)
        {
            string languageCode = (string)CookieManager.GetCookie(HttpContext.Current, CookieManager.CookieName.CurrentLanguage);
            List<ComboBoxItems> ComboboxItems = new List<ComboBoxItems>();
            foreach (iSISModel.Curriculum item in Items)
            {
                ComboboxItems.Add(new ComboBoxItems(item.StartingClassLevel.Title.GetValue(languageCode) + " - " + item.EndingClassLevel.Title.GetValue(languageCode), item.ID.ToString()));
            }
            return ComboboxItems;
        }
        #endregion
