...
namespace TSIS.Models
{
    ...
    public class WebSessionContext : SessionContext
    {
        ...
        public WebSessionContext(HttpSessionStateBase session)
        {
        ...
        public School CurrentSchool
        {
            get
            {
                ...
                {
                    //this.currentSchool = (School)this.User.Organization;
                    /*
                    this.currentSchool = this.PersistenceSession.QueryOver<School>().Where(s => s.OfficialIDNo == "0000000001")
                                          .SingleOrDefault();
                    */
                    this.currentSchool = (iSISModel.School)SessionManager.GetSession(SessionManager.SessionName.CurrentSchool);
                }
