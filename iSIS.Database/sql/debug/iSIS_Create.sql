/*
Deployment script for iSIS.Database
...
GO
:setvar DatabaseName "iSIS.Database"
:setvar DefaultFilePrefix "iSIS.Database"
...
GO
PRINT N'Creating [dbo].[AccountingPeriod]...';
...
GO
PRINT N'Creating [dbo].[JournalEntry]...';
...
GO
PRINT N'Creating [dbo].[AccountingTransaction]...';
...
GO
PRINT N'Creating [dbo].[AccountingTransaction].[AccountingTransaction_IX]...';


GO
CREATE NONCLUSTERED INDEX [AccountingTransaction_IX]
    ON [dbo].[AccountingTransaction]([LedgerID] ASC);


GO
PRINT N'Creating [dbo].[ChartOfAccount]...';
...
GO
PRINT N'Creating [dbo].[CourseSectionPerformance]...';
...
GO
PRINT N'Creating [dbo].[CourseSectionAppraisal]...';
...
GO
PRINT N'Creating [dbo].[CourseSectionAppraisal].[CourseSectionAppraisal_IX]...';


GO
CREATE NONCLUSTERED INDEX [CourseSectionAppraisal_IX]
    ON [dbo].[CourseSectionAppraisal]([CourseSectionID] ASC, [SeqNo] ASC);
...
GO
PRINT N'Creating unnamed constraint on [dbo].[AccountingPeriod]...';
...
GO
ALTER TABLE [dbo].[AccountingPeriod]
    ADD DEFAULT (0) FOR [BeginningBalance];
...
GO
ALTER TABLE [dbo].[AccountingPeriod]
    ADD DEFAULT (0) FOR [EndingBalance];


GO
PRINT N'Creating unnamed constraint on [dbo].[JournalEntry]...';


GO
ALTER TABLE [dbo].[JournalEntry]
    ADD DEFAULT (0) FOR [BalanceType];


GO
PRINT N'Creating unnamed constraint on [dbo].[AccountingTransaction]...';


GO
ALTER TABLE [dbo].[AccountingTransaction]
    ADD DEFAULT (0) FOR [BalanceType];
...
GO
ALTER TABLE [dbo].[AccountingTransaction]
    ADD DEFAULT (0) FOR [EntryType];


GO
PRINT N'Creating unnamed constraint on [dbo].[ChartOfAccount]...';


GO
ALTER TABLE [dbo].[ChartOfAccount]
    ADD DEFAULT (0) FOR [Balance];
